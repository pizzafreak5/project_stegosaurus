...
public class Image_decoder {
    ...
    public static String linear_decode(String original_filename, String secret_filename) throws IOException {
        ...
        Since we only use the last bit in the integer (either 00000000 or 00000001) we
        use the << bitwise shift operator to only have that last bit and write
        it to the file. 
        
        Close the file and if the program got this far everything was done successfully.
         */
